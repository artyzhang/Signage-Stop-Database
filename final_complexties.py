...
Location1 = r"C:\Temp_CS\Signage-Stop-Database\StopIDv26Database_merging.xlsx"
Location2 = r"C:\Temp_CS\Testfolder\stop_categorization.xlsx"
...
reference_list = [x.strip() if trystr(x) else x for x in set(reference_df['ROUTE_NAME'].tolist())]
reference_dict = {}
